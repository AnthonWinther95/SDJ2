...
public class FXMLDocumentController implements Initializable {
    ...
    private Synchronize transcript;
    
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        transcript = new Synchronize();
...
class HandleAClient implements Runnable, chat.ChatInterface {
    private Socket socket; // A connected socket
    private Synchronize transcript; // Reference to shared transcript
    private TextArea textArea;
    private String handle;

    public HandleAClient(Socket socket,Synchronize transcript,TextArea textArea) {
      this.socket = socket;
